...
data12 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_AGL.csv")))    #01, 005, 001
data13 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_GFI.csv")))
data14 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_IMP.csv")))
data15 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_NED.csv")))
data16 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_REM.csv")))
data17 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_SBK.csv")))
data18 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_SOL.csv")))
data19 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_SNH.csv")))
...
data28 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum_oneOut_AGL.csv")))
data29 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum_oneOut_GFI.csv")))
data30 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum_oneOut_IMP.csv")))
data31 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum_oneOut_NED.csv")))
data32 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum_oneOut_REM.csv")))
data33 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum_oneOut_SBK.csv")))
data34 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum_oneOut_SOL.csv")))
data35 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum_oneOut_SNH.csv")))
...
plt.xticks(ind+(width), labels)
plt.legend((p1[0], p2[0]), ('3 Output nodes', '1 Output node'))
plt.title("Annualised returns (%) of the in sample data (3 Output nodes vs 1 Output node)")
plt.xlabel("Stock")
plt.ylabel("Returns (%)")
plt.show()
...
plt.xticks(ind+(width), labels)
plt.legend((p1[0], p2[0]), ('3 Output nodes', '1 Output node'))
plt.title("Annualised returns (%) of the out sample data (3 Output nodes vs 1 Output node)")
plt.xlabel("Stock")
plt.ylabel("Returns (%)")
plt.show()
