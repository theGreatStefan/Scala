...
object main extends App {
    ...
    filename = "../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum_oneOut_SNH.csv"
    ...
    for (i <- 0 to runs-1) {
        ...
        var swarm1 = new swarm(150, 28, 1.496180, 1.496180, 0.729844, -1/(Math.sqrt(6)), 1/(Math.sqrt(6)), stockData, aroonUps,
                                                                                                                    aroonDowns,
                                                                                                                    percentageBBands,
                                                                                                                    mACDs1,
                                                                                                                    mACDs2,
