...
for stock in stocks:
    ...
    #CEQPSO_data = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum10_"+stock+".csv")))
    #CEQPSO_data = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_quantum_"+stock+".csv")))
...
plt.legend((p1[0], p2[0], p3[0], p4[0]), ('CEQPSO regression', 'CEPSO', 'BH', 'Rule'))
plt.xlabel("Stock")
plt.ylabel("Returns (%)")
plt.show()
