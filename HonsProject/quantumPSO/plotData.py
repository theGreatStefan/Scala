...
data12 = list(csv.reader(open("../testOutput/SA/Demo_AGL.csv")))    #01, 005, 001
...
data28 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_AGL.csv")))
data29 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_GFI.csv")))
data30 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_IMP.csv")))
data31 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_NED.csv")))
data32 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_REM.csv")))
data33 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_SBK.csv")))
data34 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_SOL.csv")))
data35 = list(csv.reader(open("../testOutput/SA/CEPSO_Sigmoid_WeightDecay005_Vmax40_quantum33_SNH.csv")))
...
plt.xticks(ind+(width), labels)
plt.legend((p1[0], p2[0]), ('PSO', 'QPSO'))
plt.title("Annualised returns (%) of the in sample data (PSO vs quantumPSO)")
plt.xlabel("Stock")
plt.ylabel("Returns (%)")
plt.show()
...
plt.xticks(ind+(width), labels)
plt.legend((p1[0], p2[0]), ('PSO', 'QPSO'))
plt.title("Annualised returns (%) of the out sample data (PSO vs quantumPSO)")
plt.xlabel("Stock")
plt.ylabel("Returns (%)")
plt.show()
